...
class ACloud_Sys_Core_HttpClient {
	function get($host, $data, $timeout = 5) {
		return function_exists ( "curl_init" ) ? ACloud_Sys_Core_HttpClient::curlRequest ( $host, $data, $timeout ) : ACloud_Sys_Core_HttpClient::request ( $host, $data, 'GET', $timeout );
	}
	function post($host, $data, $timeout = 5) {
		return function_exists ( "curl_init" ) ? ACloud_Sys_Core_HttpClient::curlRequest ( $host, $data, $timeout ) : ACloud_Sys_Core_HttpClient::request ( $host, $data, 'POST', $timeout );
	}
	...
	function curlRequest($host, $data, $timeout = 5) {
		$ch = curl_init ();
