var rate = {
	...
	voteLoading : function() {
		return '<div class="c"></div><div class="mood-bg"><div class="mood-bg2"><div style="padding:30px;"><img src="images/loading.gif" align="absmiddle" /> Мгдижа...</div></div></div><div class="c"></div>';
	},
