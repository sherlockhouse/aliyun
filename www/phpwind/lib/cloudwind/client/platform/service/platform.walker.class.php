...
class CloudWind_Platform_Walker extends CloudWind_Core_Service {
	...
	function checkversionWalker() {
		$settingService = $this->getPlatformSettingService ();
		return $settingService->getCloudWindVersion ();
	}
	function _getWalkers() {
		return array ('check', 'init', 'hook', 'open', 'sethash', 'model', 'expand', 'defend', 'domain', 'unique', 'setting', 'syncinit', 'synccheck', 'syncsetting', 'checksetting', 'checkversion', 'checksite' );
	}
