...
if($debate[judge]){
	...
	$specialTips .= "辩论结束时间：{$debate[endtime]} ， 裁判：<a href=\"u.php?username={$debate[umpire]}\" class=\"mr10 _cardshow\" target=\"_blank\" data-card-url=\"pw_ajax.php?action=smallcard&type=showcard&username=".rawurlencode($debate['umpire'])."\" data-card-key=$debate[umpire] >$debate[umpire]</a>";
