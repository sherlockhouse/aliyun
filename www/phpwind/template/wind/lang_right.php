...
$lang['right'] = array (
	...
	'basic' => array(
		...
		*/
		...
		'atnum'	=> array(
			'title'	=> '可@用户数',
			'desc'	=> '可@用户数上限，0或留空表示不限制',
			'html'	=> '<input class="input input_wa" value="$atnum" name="group[atnum]" />'
		),
		'allowvideo' => array(
			'title'	=> '允许发视频帖',
			'desc'	=> '允许此用户组用户发视频帖',
			'html'	=> '<ul class="list_A list_80 cc"><li><input type="radio" value="1" name="group[allowvideo]" $allowvideo_Y />开启</li><li><input type="radio" value="0" name="group[allowvideo]" $allowvideo_N />关闭</li></ul>'
		),
		'allowmusic' => array(
			'title'	=> '允许发音乐帖',
			'desc'	=> '允许此用户组用户发音乐帖',
			'html'	=> '<ul class="list_A list_80 cc"><li><input type="radio" value="1" name="group[allowmusic]" $allowmusic_Y />开启</li><li><input type="radio" value="0" name="group[allowmusic]" $allowmusic_N />关闭</li></ul>'
		),
	),
	'read'	=> array(
		'allowpost'	=> array(
	...
	'system'	=> array(
		...
		'forumcolonyright' => array(
			'title'	=> '关联版块群组管理权限',
			'desc'	=> "开启了此权限，此类用户将具备关联版块中群组的管理权限",
